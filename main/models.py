'''dette er filen som lager modelsene våre'''
...
class Room(models.Model):
    '''Modellen for rom.'''
    room_choices = [('S', 'Single Occupancy'),
                    ('D', 'Double Occupancy'), ('F', 'Firemannsrom')]
    ...
    def __str__(self):
        return "Romnr: " + str(self.room_no) + \
            " -- type:" + str(self.room_type)


class Booking(models.Model):
    '''Modellen for bookinger'''
    ...
    # eller settings.AUTH_USER_MODEL
    ...
    def __str__(self):
        return "Bruker: " + self.guest.__str__() + " -- id:" + str(self.bookingid) + " -- Inndato: " + \
            self.cin_date.__str__() + " -- Utdato: " + self.cout_date.__str__() + " -- " + self.room.__str__()
